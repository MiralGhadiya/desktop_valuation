...
from app.models.valuation import DesktopValuationForm, DesktopValuationFormDep
...
def test_openai():
    ...
    try:
        response = client.models.retrieve("gpt-4.1-mini")
        return {"success": True, "model": response.id}
